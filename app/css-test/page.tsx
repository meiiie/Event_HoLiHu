  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
        ...
        <TabsContent value="test2" className="mt-4"></TabsContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
            ...
            <div></div>
              <h2 className="text-2xl font-bold mb-4">Custom Alerts</h2>
              
              <Alert className="mb-4">
                <AlertDescription>This is a default alert</AlertDescription>
              </Alert>
              
              <Alert className="mb-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-900/50">
                <AlertDescription className="text-blue-800 dark:text-blue-300">Custom styled alert</AlertDescription>
              </Alert>
              
              <div className="event-item"></div>
                <h4 className="font-medium">Event Item</h4>
                <p className="text-sm">This should have a left border that changes on hover</p>
              </div>
            </div>
          </div>
        </TabsContent>
